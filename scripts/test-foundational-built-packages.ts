...
runNode(
  ...
  [
    ...
    "  ['ContractRegistryError', 'createContractRegistry', 'getTokenInterface', 'isContractId', 'listContractIds', 'resolveBasicPoolInterface', 'resolveContract', 'resolveEvent', 'resolveHistoricalContractEvidence', 'resolveOperation', 'resolveRoleInterface', 'resolveRuntimeIdentity', 'resolveVotingInterface', 'resolveVotingRewardInterface'],",
