...
const validator = resolve(repositoryRoot, "scripts/checks/validate-knowledge-structure.ts");
const semanticValidator = resolve(
  repositoryRoot,
  "scripts/checks/validate-knowledge-authoring-example.ts",
);
const generator = resolve(
  repositoryRoot,
  "scripts/generate/generate-knowledge-authoring-example.ts",
);
