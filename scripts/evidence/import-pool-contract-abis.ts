...
for (const definition of definitions) {
  ...
  records.push({
    ...
    reproduction: {
      procedure:
        "Fetch the recorded explorer bundle, create an isolated Foundry project with scripts/evidence/reproduce-explorer-contract.ts, compile with the exact explorer compiler/settings, and compare with scripts/evidence/compare-explorer-build.ts.",
