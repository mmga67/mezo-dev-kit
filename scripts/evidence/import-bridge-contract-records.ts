...
if (
  ...
  throw new Error(
    "usage: node scripts/evidence/import-bridge-contract-records.ts " +
...
const nativeReproduction = {
  ...
  buildProcedure:
    "Download the Etherscan Exact Match multi-file source page, extract its synthetic settings.json with scripts/evidence/extract-etherscan-standard-json.ts, compile with solc v0.8.24+commit.e11b9ed9 --standard-json, and compare the creation transaction/runtime with scripts/evidence/compare-standard-json-build.ts.",
