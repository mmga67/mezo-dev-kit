...
for (const definition of definitions) {
  ...
  const provenance = {
    ...
    librariesSha256,
    buildProcedure:
      "Fetch the official explorer bundle, create an isolated Foundry project with scripts/evidence/reproduce-explorer-contract.ts, compile with the exact explorer compiler/settings, compare executable bytes with scripts/evidence/compare-explorer-build.ts, and compare the ABI semantically.",
