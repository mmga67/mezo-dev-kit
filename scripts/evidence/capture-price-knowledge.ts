...
if (!outputPath || !documentationRepository || !clientRepository || !pythRepository) {
  throw new Error(
    "usage: node scripts/evidence/capture-price-knowledge.ts <output-json> <official-documentation-repository> <official-mezod-repository> <official-pyth-crosschain-repository> [--network mezo-mainnet|mezo-testnet]",
  );
}
