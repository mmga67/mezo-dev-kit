...
async function main(): Promise<void> {
    ...
    checks: [
      {
        id: "common-structure",
        type: "structural",
        command: "node scripts/checks/validate-knowledge-structure.ts --module contracts",
      },
      {
        id: "contract-semantics",
        type: "semantic",
        command: "node scripts/checks/validate-contract-knowledge.ts",
      },
      {
        id: "contract-reference-drift",
        type: "drift",
        command: "node scripts/generate/generate-contract-reference.ts --check",
      },
    ],
    extensions: {
      registryStatus: "verified-current",
  ...
  await execFileAsync(process.execPath, [
    join(repositoryRoot, "scripts/generate/generate-contract-reference.ts"),
  ]);
