...
for (const definition of definitions) {
  ...
  const reproduction = {
    ...
    buildProcedure:
      "Fetch the recorded explorer source bundle, materialize it with scripts/evidence/reproduce-explorer-contract.ts, build with the exact Foundry compiler/settings, and compare creation/runtime executables with scripts/evidence/compare-explorer-build.ts.",
