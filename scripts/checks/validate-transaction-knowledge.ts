...
assert(
  ...
  "client and transaction lifecycle architecture must remain accepted",
);
...
assert(
  generatedReference.includes("- Architecture: `accepted`"),
  "generated reference must preserve accepted architecture status",
);
