...
const scopedValidators = new Set([
  "scripts/checks/validate-contract-knowledge.ts",
  "scripts/checks/validate-price-knowledge.ts",
]);
if (process.argv.length !== 2)
  throw new Error("usage: node scripts/checks/check-mainnet-reader-evidence.ts");
